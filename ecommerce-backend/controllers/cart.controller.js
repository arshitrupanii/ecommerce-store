...
export const getcartItems = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Error Cart Items" })
    }
}
...
export const addtoCart = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Error add To cart" })
    }
}
...
export const removeAllItems = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Error remove all items" })
...
export const updateQuantity = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Error updateQuantity" })
